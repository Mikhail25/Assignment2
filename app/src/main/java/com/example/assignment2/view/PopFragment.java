...
import com.example.assignment2.presenter.PopPresenter;
import com.example.assignment2.presenter.PopPresenterContract;
...
public class PopFragment extends Fragment implements ViewContract{
    ...
    PopPresenterContract popPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        popPresenter = new PopPresenter(this);
        popPresenter.initializeRetrofit();
