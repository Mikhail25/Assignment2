...
import com.example.assignment2.presenter.RockPresenter;
import com.example.assignment2.presenter.RockPresenterContract;
...
public class RockFragment extends Fragment implements ViewContract{
    ...
    RockPresenterContract rockPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rockPresenter = new RockPresenter(this);
        rockPresenter.initializeRetrofit();


        recyclerView = rootView.findViewById(R.id.recyclerViewRock);
